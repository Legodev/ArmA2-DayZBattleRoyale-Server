    ...
    while {ELAPSED_TIME < END_TIME} do  {
        ...
        if((_finish_time_minutes == 62) && (_finish_time_seconds < 50)) then
        {
			...
			if (br_totalplayers >= 11) then {
					...
					[] execVM "\z\addons\dayz_server\battleroyal\zones\isoladicapraia_fn_addmarker.sqf";
				
				} else {
				
					[] execVM "\z\addons\dayz_server\battleroyal\zones\isoladicapraia_fn_addmarkerShort90.sqf";
