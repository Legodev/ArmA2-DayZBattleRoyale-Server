...
if ((preprocessFileLineNumbers format ["\z\addons\dayz_server\battleroyal\vehicles\predefined\%1_vehicles_array.sqf",_map]) != "") then {
	_vehArray = call compile preProcessFileLineNumbers format ["\z\addons\dayz_server\battleroyal\vehicles\predefined\%1_vehicles_array.sqf",_map];
} else {
...
if(DZEBR_DynamicVehicleSpawn || _vehcount == 0) then {
	...
	_vehArray = _vehcount call compile preProcessFileLineNumbers "\z\addons\dayz_server\battleroyal\vehicles\random\random_vehicles_array.sqf";
};
...
if(DZEBR_RandomVehiclePosition) then {
	...
	*/
	...
	random_vehicles_position = compile preprocessFileLineNumbers "\z\addons\dayz_server\battleroyal\vehicles\random\random_vehicles_position.sqf";
};

add_random_vehicle_loot = compile preprocessFileLineNumbers "\z\addons\dayz_server\battleroyal\vehicles\random\add_random_vehicle_loot.sqf";
